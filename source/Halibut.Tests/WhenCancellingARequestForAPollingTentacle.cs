        ...
        public class AndTheRequestHasBeenDequeuedButNoResponseReceived : BaseTest
        {
            ...
            public async Task TheRequestShouldBeCancelled_WhenTheRequestCancellationTokenIsCancelled(ClientAndServiceTestCase clientAndServiceTestCase)
            {
                           ...
                           .Build(CancellationToken))
                {
                    ...
                    (await AssertAsync.Throws<Exception>(() => doSomeActionService.ActionAsync(halibutProxyRequestOptions))).And
                        .Should().BeTaskOrOperationCancelledException();
                ...
                responseMessages.ElementAt(0).Error.Message.Should().ContainAny("operation was cancelled", "A task was canceled");
